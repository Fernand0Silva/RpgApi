...
namespace RpgApi.Data
{
    ...
    {
        internal readonly object Disputas;
        ...
        public object TB { get; internal set; }
        public object TB_DISPUTAS { get; internal set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
           ...
           /* modelBuilder.Entity<Disputa>().HasKey(d => d.Id);//Indicação da chave primária da entidade.
            //Abaixo ficà o mapeamento do nome das colunas da tabela para as propriedade da classe
            modelBuilder.Entity<Disputa>().Property(d => d.DataDisputa).HasColumnName("Dt_Disputa");
           /* modelBuilder.Entity<Disputa>().Property(d => d.Atacanteaid).HasColumnName("AtacanteId");
